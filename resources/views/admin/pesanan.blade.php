                                    ...
                                    <td>
                                        <a href="/adm_dtl_pesanan/{{$dat->order_id}}">
                                            <button type="button" class="btn btn-success">
                                                <i class="fa fa-lg fa-check"></i>Detail
                                            </button>
                                        </a>
                                        <a href="/adm_pesanan_terima/{{$dat->order_id}}" class="btn btn-primary">Terima</a>
                                        <a href="/adm_pesanan_tolak/{{$dat->order_id}}" class="btn btn-danger">Tolak</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
