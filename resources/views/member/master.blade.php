        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="custom-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="/member">Beranda</a></li>
                    <li><a href="/member/produk">Produk Kami</a></li>
                    <li><a href="/member/contact">Hubungi Kami</a></li>
                    <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Profil </a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="/member/account">Akun Saya</a>
                            </li>
                            <li><a href="/member/logout">Keluar</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="/member/chekout"><span class="icon-basket" id="cart">({{Cart::count()}}) </span> Chekout</a></li>
                </ul>
            </div>
        </div>
    </nav>
