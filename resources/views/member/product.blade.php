                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4">
                            <div class="shop-item">
                                <div class="shop-item-image"><img src="{{asset('product/'.$item->image_url)}}"
                                    ...
                                    <div class="shop-item-detail"><a href="/member/cart/add/{{$item->product_id}}" class="btn btn-round btn-b btn-add"><span
                                                    class="icon-basket">Add To Cart</span></a>
                                    </div>
                                </div>
                                <h4 class="shop-item-title font-alt"><a
                                            href="/member/detail/{{$item->product_id}}">{{$item->product_name}}</a></h4>
                                Rp. {{$item->unit_price}}
                            </div>
                        </div>
                    @endforeach
